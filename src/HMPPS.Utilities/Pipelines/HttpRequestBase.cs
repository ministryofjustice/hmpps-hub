...
namespace HMPPS.Utilities.Pipelines
{
    public abstract class HttpRequestBase : HttpRequestProcessor
    {
        ...
        private bool SitesAllowed()
        {
            ...
            var contextSiteName = Sitecore.Context.GetSiteName();
        ...
        private bool ModeNotIgnored()
        {
            ...
            var isEditor = Sitecore.Context.PageMode.IsExperienceEditor;

            return !modes.Any(mode =>
              (mode == "Edit" && isEditor) ||
              (mode == "Preview" && Sitecore.Context.PageMode.IsPreview)
            );
        }
        ...
        private bool DatabaseAllowed()
        {
            ...
            var contextDatabaseName = Sitecore.Context.Database.Name;
