...
<!--[if gt IE 8]><!--><link href="/hmppsAssets/css/hmpps.css?d=27102017" rel="stylesheet" type="text/css"><!--<![endif]-->
...
<body class="">
    ...
    <div class="header-wrapper">
        <div class="header-global">
            <a class="content" title="Go to the hub homepage" href="/" id="logo">The Hub</a>
        </div>
    </div>
</header>
    ...
    <div class="site-wrapper">
        <main class="elements-index root-index" id="content" role="main" tabindex="-1">
            <div class="pub-c-title">
                <h1 class="heading-xlarge">Access not allowed</h1>
            </div>
            <div class="grid-row">
                <div class="column-two-thirds">
                    <div class="content">
                        <p>Sorry, but you are not allowed to access this page. You should go back to your home page and start again.</p>
                        <p><a href="/">Back to home</a></p>
                    </div>
                </div>
            </div>
            <div class="pub-c-title">
                <h1 class="heading-xlarge">Ni chaniateir mynediad</h1>
            </div>
            <div class="grid-row">
                <div class="column-two-thirds">
                    <div class="content">
                        <p>Mae'n ddrwg gennym, ond nid oes hawl gennych i gael mynediad i'r dudalen hon. Dylech fynd yn ôl i'ch tudalen gartref a dechrau eto.</p>
...
<script src="/hmppsAssets/js/application.js?d=27102017"></script>
