  ...
  */  var $, Chosen, get_side_border_padding, root;
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.choice_destroy_link_click = function(evt) {
      ...
      return this.choice_destroy($(evt.target), true);
    };
    Chosen.prototype.choice_destroy = function(link, forceBlur) {
      this.choices -= 1;
      this.show_search_field_default();
      ...
      if (this.is_multiple && this.choices < 1 && !this.active_field && forceBlur) {        
        this.blur_test();
      }
